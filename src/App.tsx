            ...
            <SectionWrapper className="bg-white p-8 rounded-xl shadow-sm border border-gray-200 transition-shadow duration-300" delay={0.2}>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-lg leading-relaxed text-gray-600">Receba R$ 100,00 por indicação de clínica <br /> e R$ 10,00 por R$ 1.000,00 do valor do tratamento do paciente indicado.</p>
                </div>
              </div>
            </SectionWrapper>
